...
public class ToolMail {
	...
	public static void main(String[] args) {
		...
		String from = "gdouse1133@163.com";		// 邮件发送者的地址
		String userName = "gdouse1133@163.com";	// 登陆邮件发送服务器的用户名
		String password = "ruanjian1133";	// 登陆邮件发送服务器的密码
		
		List<String> to = new ArrayList<String>();			// 邮件接收者的地址
		to.add("7985559020@qq.com");
